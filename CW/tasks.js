...
for (const i of simpsons) {
    ...
    member.innerText = `${i.name} ${i.surname} ${i.age} ${i.info} ${i.photo}`;
...
for (const i of simpsons) {
    ...
    nameBlock.innerText = `${i.name}`;

    let surnameBlock = document.createElement('div');
    surnameBlock.innerText =`${i.surname}`;

    let ageBlock = document.createElement('div');
    ageBlock.innerText = `${i.age}`;

    let infoBlock = document.createElement('div');
    infoBlock.innerText = `${i.info}`;

    let photoBlock = document.createElement('div');
    photoBlock.innerText = `${i.photo}`;

    member.appendChild(nameBlock);
    member.appendChild(surnameBlock);
    member.appendChild(ageBlock);
    member.appendChild(infoBlock);
    member.appendChild(photoBlock);
}
*/
